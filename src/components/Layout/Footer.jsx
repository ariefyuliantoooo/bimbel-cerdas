        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-8">
            <Link to="/" className="flex items-center space-x-3">
              <div className="h-12 w-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg">B</div>
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a key={i} href={social.url || '#'} target="_blank" rel="noreferrer" className="h-11 w-11 bg-slate-800 rounded-xl flex items-center justify-center hover:bg-indigo-600 transition-all transform hover:-translate-y-1">
                  <social.icon size={20} />
                </a>
              ))}
            </div>
          ...
          <div>
            <h3 className="text-xl font-black mb-8">Tautan Cepat</h3>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xl font-black mb-8">Hubungi Kami</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  <div className="h-12 w-12 bg-slate-800 rounded-2xl flex items-center justify-center text-indigo-400 group-hover:bg-indigo-600 group-hover:text-white transition-all shrink-0">
                    <Phone size={20} />
                  </div>
                  <div>
                    <p className="text-xs font-black text-slate-500 uppercase tracking-widest mb-1">WhatsApp</p>
                    <p className="font-bold">{settings.wa_number || '+62 852 7212 3300'}</p>
                    <p className="text-xs text-slate-500">{settings.wa_secondary}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="h-12 w-12 bg-slate-800 rounded-2xl flex items-center justify-center text-indigo-400 group-hover:bg-indigo-600 group-hover:text-white transition-all shrink-0">
                  ...
                  <div>
                    ...
                    <p className="font-bold truncate">{settings.email || 'ariefariefarief580@gmail.com'}</p>
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-4 group">
